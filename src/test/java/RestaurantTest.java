...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        Mockito.when(spiedRestaurant.getCurrentTime()).thenReturn(LocalTime.of(12, 30));
        boolean isRestaurantOpen = spiedRestaurant.isRestaurantOpen();
        assertThat(isRestaurantOpen, equalTo(Boolean.TRUE));
    }

    @Test
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        Restaurant spiedRestaurant = Mockito.spy(restaurant);
        Mockito.when(spiedRestaurant.getCurrentTime()).thenReturn(LocalTime.of(23, 30));
        boolean isRestaurantOpen = spiedRestaurant.isRestaurantOpen();
        assertThat(isRestaurantOpen, equalTo(Boolean.FALSE));
